...
public class VideoGameReferenceRepository(IMongoDatabase mongoDatabase, IMapper mapper) : IVideoGameReferenceRepository
{
    ...
    public async Task<VideoGameReferenceModel?> FindByIdAsync(string id)
    {
        ...
        return entity is null ? null : mapper.Map<VideoGameReferenceModel>(entity);
    }
    ...
    public async Task<List<VideoGameReferenceModel>> FindAllAsync()
    {
        ...
        return entities.Select(mapper.Map<VideoGameReferenceModel>).ToList();
    }
    ...
    public async Task<VideoGameReferenceModel> UpsertAsync(VideoGameReferenceModel model)
    {
        ...
        var entity = mapper.Map<VideoGameReference>(model);
        ...
        return mapper.Map<VideoGameReferenceModel>(entity);
    }
}
