...
public class BookDto : IHasId, IReferenceLinkedDto
{
    ...
    /// <summary>
    /// Denormalized primary-source (the linking book provider's, 0-5) rating from the linked reference, on
    /// <see cref="ReferenceRatingScale"/>. Server-managed on link/refresh, round-tripped on edits; null until
    /// linked. Full breakdown on <see cref="BookReferenceDto.Ratings"/>.
    /// </summary>
