...
/// </summary>
public abstract partial class ReferenceableDetailPageBase(IPage page, string providerName) : DetailPageBase(page)
{
    ...
    {
        var searchButton = Page.GetByRole(AriaRole.Button, new PageGetByRoleOptions { Name = $"Search {providerName} to link" });
