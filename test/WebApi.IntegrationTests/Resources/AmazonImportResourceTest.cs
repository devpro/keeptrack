    ...
    : ResourceTestBase(factory)
{
    ...
    public async Task PreviewThenCommit_CreatesOneItemPerMediaType_AndFlagsThemAllAlreadyImportedOnReimport()
    {
        ...
        TrackResourcesMatching<BookDto>("/api/books", AmazonFixtureCsvBuilder.BookTitle);
        TrackResourcesMatching<MovieDto>("/api/movies", AmazonFixtureCsvBuilder.MovieTitle);
        TrackResourcesMatching<TvShowDto>("/api/tv-shows", AmazonFixtureCsvBuilder.TvShowTitle);
        TrackResourcesMatching<VideoGameDto>("/api/video-games", AmazonFixtureCsvBuilder.VideoGameTitle);
        TrackResourcesMatching<GearDto>("/api/gear", AmazonFixtureCsvBuilder.GearTitle);
        TrackResourcesMatching<CollectibleDto>("/api/collectibles", AmazonFixtureCsvBuilder.CollectibleTitle);
    ...
    public async Task Commit_ImportsBothItems_WhenTwoDifferentBooksShareTheSameOrder()
    {
        ...
        TrackResourcesMatching<BookDto>("/api/books", firstTitle);
        TrackResourcesMatching<BookDto>("/api/books", secondTitle);
