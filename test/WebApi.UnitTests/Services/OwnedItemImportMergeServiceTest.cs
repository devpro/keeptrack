...
public class OwnedItemImportMergeServiceTest
{
    ...
    public void FindImportedReferences_ReturnsOnlyNonNullReferences()
    {
        ...
        var result = OwnedItemImportMergeService.FindImportedReferences(existingBooks, b => b.OwnedVersions.Select(v => v.Reference));
    ...
    public void FindImportedReferences_WorksAcrossVideoGamePlatformsToo()
    {
        ...
        var result = OwnedItemImportMergeService.FindImportedReferences(existingGames, g => g.Platforms.Select(p => p.Reference));
